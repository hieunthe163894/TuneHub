...
export default function TrackStatistic({ artistId, date }) {
        ...
        <table className="w-full table-fixed">
          <thead className="font-semibold">
            <tr className="border-b border-neutral-300">
              ...
              <th className="w-3/12 text-left">Song</th>
              <th className="w-2/12 text-center">Album</th>
              <th className="w-2/12 text-center">Stream time</th>
              <th className="w-2/12 text-center">Price</th>
